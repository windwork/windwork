 ...
 * @link        http://docs.windwork.org/manual/wf.core.benchmark.html
 * @since       0.1.0
 */
final class Benchmark 
{
     ...
     * 开始记录
     * 
     * 如果已defined('WF_START_TIME', microtime(true))，则使用WF_START_TIME作为开始时间
     * 
     * @return array 
     * <pre>
     * [
    ...
    public static function start()
    {
        ...
        // 如果已定义WF_START_TIME并且格式是microtime(1)的，就使用作为初始时间，否则使用当前microtime
        $startTime = (defined(WF_START_TIME) && preg_match("/^1\\d{9}\\.\\d+/", WF_START_TIME, $m)) ? WF_START_TIME : microtime(true);
